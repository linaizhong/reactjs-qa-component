...
function MultimediaEditor(_ref) {
  ...
  var _useState = useState(initialType),
    _useState2 = _slicedToArray(_useState, 2),
...
function QAEditor(_ref) {
  ...
  var _useState = useState((initialData === null || initialData === void 0 ? void 0 : initialData.question) || {
      type: MEDIA_TYPES.TEXT,
      content: '',
      file: null
    }),
  ...
  var _useState3 = useState((initialData === null || initialData === void 0 ? void 0 : initialData.answers) || [{
      id: 1,
      type: MEDIA_TYPES.TEXT,
      content: '',
      file: null,
...
function QAPlayer(_ref) {
  ...
  var _useState = useState(showAnswersInitially),
    _useState2 = _slicedToArray(_useState, 2),
...
export { MEDIA_TYPES, QAEditor, QAPlayer };
